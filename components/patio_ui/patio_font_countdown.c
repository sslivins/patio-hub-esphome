 ...
 * Size: 96 px
 * Bpp: 4
 * Opts: --bpp 4 --size 96 --font Montserrat-Medium.ttf -r 0x30-0x3A --format lvgl -o C:\Users\stesli\code\patio-hub-esphome\components\patio_ui\patio_font_countdown.c --force-fast-kern-format --no-compress
 ******************************************************************************/
...
#ifndef PATIO_FONT_COUNTDOWN
#define PATIO_FONT_COUNTDOWN 1
#endif

#if PATIO_FONT_COUNTDOWN
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t patio_font_countdown = {
#else
lv_font_t patio_font_countdown = {
#endif
